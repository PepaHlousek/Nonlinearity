...
plt.savefig('Allan_SLED.pdf',dpi=300,bbox_inches='tight',pad_inches = 0.01)
...
plt.savefig('Allan_SLED_zoom.pdf',dpi=300,bbox_inches='tight',pad_inches = 0.01)
